    ...
    <div class="row">
        <div class="span12">
            <div class="content">
                ...
                $id  = intval($_GET['id']);
                $sql = mysqli_query($mysqli , " SELECT * FROM cuentas WHERE id='$id' ") or die(mysqli_error());
                ...
                <form name="form1" id="form1" class="form-horizontal row-fluid" action= " <?php echo "UpdateCuentas.php" ?> " method="POST" >
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <a href="Cuentas.php" class="btn btn-sm btn-danger">Cancelar</a>
                        </div>
                    </div>
                </form>
